...
const HeroSection = (props) => {
    ...
    return (
        <div className='w-full'>
            <section className='max-w-[800px] rounded-md px-4 py-4 mx-auto my-4 bg-blue-500 lg:flex flex flex-col-reverse items-center justify-between'>
                <div className="f_content lg:w-1/2 flex flex-col items-center justify-center text-center gap-2">
