      ...
      <header className='max-w-[800px] rounded-full px-4 py-4 mx-auto my-4 bg-blue-500 h-full flex items-center justify-between'>
        ...
        <nav>
            <ul className='flex items-center justify-center gap-4'>
                <li><Link to="/bombay-portfolio" className='text-md font-medium hover:underline hover:text-xl transition-all'>Home</Link></li>
                <li><Link to="/bombay-portfolio/templates" className='text-md font-medium hover:underline hover:text-xl transition-all'>Templates</Link></li>
