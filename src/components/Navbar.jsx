  ...
  return (
    <div className='w-full'>
      <header className='max-w-[800px] rounded-full px-4 py-4 mx-auto my-4 bg-blue-500 h-full flex items-center justify-between'>
        <Link to="/" className='font-extrabold text-2xl'>DEV.Bombay</Link>
        <nav>
            <ul className='flex items-center justify-center gap-4'>
                <li><Link to="/" className='text-md font-medium hover:underline hover:text-xl transition-all'>Home</Link></li>
                <li><Link to="/templates" className='text-md font-medium hover:underline hover:text-xl transition-all'>Templates</Link></li>
